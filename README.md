# Salary-Prediction
Stackoverflow Salary Prediction
...
LICENSE
This project uses the "2023 Stack Overflow Developer Survey" and a simple ML pipeline to predict annual compensation (Salary).
